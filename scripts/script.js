        ...
        lapp: [
            {
                ...
                <p>Last updated: February 07, 2020</p>

                <p>None of your private information is stored, or shared. Akira settings and bookmarks are stored and synced using Google Chrome Sync API.</p>

                <h2>Contact Us</h2>
                <p>If you have any questions about this Disclaimer, You can contact Us:</p>
                
                <ul>
                    <li>By email: <a href="mailto: recoskyler224@gmail.com">recoskyler224@gmail.com</a></li>
                    <li>By visiting this page on our website: <a href="https://about.recoskyler.com/Pages/contact.html">https://about.recoskyler.com/Pages/contact.html</a></li>
                </ul>
                `
            },
            {
                ...
                <ul>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to Akira.</li>
                    <li><strong>You</strong> means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                    <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device named Akira.</li>    <li><strong>Service</strong> refers to the Application.</li>
                </ul>
                
                <h1>Disclaimer</h1>
                <p>The information contained on the Service is for general information purposes only.</p>
                <p>The Company assumes no responsibility for errors or omissions in the contents of the Service.</p>
                <p>In no event shall the Company be liable for any special, direct, indirect, consequential, or incidental damages or any damages whatsoever, whether in an action of contract, negligence or other tort, arising out of or in connection with the use of the Service or the contents of the Service. The Company reserves the right to make additions, deletions, or modifications to the contents on the Service at any time without prior notice. This Disclaimer is maintained by the <a href="https://www.privacypolicies.com/disclaimer-generator/">Disclaimer Generator</a></p>
    ...
    },
    {
        ...
        lapp: [
            ...
            },
            {
                ...
                <p>Last updated: February 07, 2020</p>
                <p>Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using Paws.</p>
                ...
                <ul>
                    <li><strong>Agreement</strong> means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This Agreement is maintained by the <a href="https://www.privacypolicies.com/eula-generator/">EULA Generator</a>.</li>
                    <li><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named Paws</li>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Paws.</li>
                    ...
                    <li><strong>Device</strong> means any device that can access the Application such as a computer, a cellphone or a digital tablet.</li>
                    <li><strong>Third-Party Services</strong> means any services or content (including data, information, applications and other products services) provided by a third-party that may be displayed, included or made available by the Application.</li>
    ...
    },
    {
        ...
        lapp: [
            ...
            },
            {
                ...
                <p>Last updated: February 07, 2020</p>
                <p>Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using Sabertooth.</p>
                ...
                <ul>
                    <li><strong>Agreement</strong> means this End-User License Agreement that forms the entire agreement between You and the Company regarding the use of the Application. This Agreement is maintained by the <a href="https://www.privacypolicies.com/eula-generator/">EULA Generator</a>.</li>
                    <li><strong>Application</strong> means the software program provided by the Company downloaded by You to a Device, named Sabertooth</li>
                    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sabertooth.</li>
                    <li><strong>Content</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.</li>
                    <li><strong>Country</strong> refers to: Estonia</li>
                    <li><strong>Device</strong> means any device that can access the Application such as a computer, a cellphone or a digital tablet.</li>
                    <li><strong>Third-Party Services</strong> means any services or content (including data, information, applications and other products services) provided by a third-party that may be displayed, included or made available by the Application.</li>
...
function homeScreen() {
    ...
    apps.forEach((app) => {
        ...
        appBlock.id = app.name;
        appBlock.className = "appBlock";

        appIcon.src = `./images/${app.name}.png`;
        appIcon.alt = "APP ICON";
        appIcon.className = "appIcon"

        appLabel.innerHTML = capitalizeFirstLetter(app.name);
...
function appScreen(app) {
    ...
    generateDocButtons(app);
    showElementById("appLAPP");
    appTitle.innerHTML = capitalizeFirstLetter(app.name);
}
...
function generateDocButtons(app) {
    var cnt = 0;
    var appLapp = document.getElementById("appLAPP");

    clearElementByID("appLAPP");

    app.lapp.forEach((lapp) => {
        var btn = document.createElement("span");

        btn.innerHTML = lapp.title;
        btn.id = lapp.title.toLowerCase().replace(/ /g, "");
        btn.classList.add("lapp");
        
        if (cnt === 0) btn.classList.add("sel");
        if (appLapp) {
            appLapp.appendChild(btn);

            btn = document.getElementById(btn.id);

            btn.addEventListener("click", () => {
                selectLAPP(btn.id);
                showDoc(lapp.content);
            });
        }
    ...
    showDoc(app.lapp[0].content);
}

function selectLAPP(id) {
    var lapps = document.getElementsByClassName("lapp");

    for (i = 0; i < lapps.length; i++) {
        var lapp = lapps[i];

        if (lapp.id !== id && lapp.classList.contains("sel")) lapp.classList.remove("sel");
        if (lapp.id === id && !lapp.classList.contains("sel")) lapp.classList.add("sel");
    }
}

function showDoc(content) {
    var docElem = document.getElementById("appDoc");

    if (docElem) {
        docElem.innerHTML = content;
    }
}
...
function removeAllAppBlocks() {
    ...
    while (paras.length > 0) {
        ...
        paras = document.getElementsByClassName("appBlock");
    }
}
